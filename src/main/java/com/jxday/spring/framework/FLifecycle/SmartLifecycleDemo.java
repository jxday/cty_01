package com.jxday.spring.framework.FLifecycle;

import org.springframework.context.SmartLifecycle;
import org.springframework.stereotype.Component;

/**
 * 〈    在容器 启动/停止 时调用 start(),stop() 回调方法 也可以通过容器的start，stop方法手动调用〉
 *
 * @author cty
 * @ClassName LifecycleDemo
 * @create 1/5/21 11:17 AM
 * @Version 1.0.0
 */
//@Component
public class SmartLifecycleDemo implements SmartLifecycle {
    ...
    @Override
    public void start() {
        System.err.println("this is lifecycle start method");
        isRunning = true;
    }
    ...
    public void stop(Runnable callback) {
        System.err.println("stop(Runnable)============================");
